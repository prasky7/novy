...
namespace AnalogClock
{
    public partial class Form1 : Form
    {
        ...
        private void t_Tick(object sender, EventArgs e)
        {
            ...
            //draw figure
            g.DrawString("12", new Font("Arial", 12), Brushes.Red, new PointF(140, 2));
            g.DrawString("3", new Font("Arial", 12), Brushes.Red, new PointF(286, 140));
            g.DrawString("6", new Font("Arial", 12), Brushes.Red, new PointF(142, 282));
            g.DrawString("9", new Font("Arial", 12), Brushes.Red, new PointF(0, 140));
